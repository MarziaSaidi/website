        ...
        <Card>
          <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-2">
              <label htmlFor="contact-name" className="text-xs tracking-meta uppercase text-text-secondary">
                Your Name
              </label>
              <input
                id="contact-name"
            ...
            <div className="flex flex-col gap-2">
              <label htmlFor="contact-email" className="text-xs tracking-meta uppercase text-text-secondary">
                Email Address
              </label>
              <input
                id="contact-email"
            ...
            <div className="flex flex-col gap-2">
              <label htmlFor="contact-msg" className="text-xs tracking-meta uppercase text-text-secondary">
                Message
              </label>
              <textarea
                id="contact-msg"
            ...
            {/* The submit control uses the same Button as every other CTA —
                the quiet variant, so it reads as the form's own action
                rather than competing with the page's primary buttons, but
                with the identical label/icon choreography. */}
            <Button
              as="button"
              type="submit"
              variant="quiet"
