export default function Button({
  ...
  const base =
    "hover-lift active:scale-[0.97] inline-flex items-center gap-2 px-8 py-3.5 text-sm tracking-wide rounded-md border focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-bronze focus-visible:ring-offset-2 focus-visible:ring-offset-background";
